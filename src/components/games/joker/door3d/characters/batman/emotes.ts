...
/**
 * Batman (Origins Suit) Animation Keyframe Emote Tracks
 * Explicitly written without any spread/copy functions.
 * Scanner emote uses the exact Joker coordination.
 */
export const BATMAN_EMOTES: CharacterEmoteTracks = {
    idle: [
        {
            percentage: 0,
    ...
    scanner: [
        { percentage: 0, name: '0% Idle Normal Rest', la: { x: 0, y: 0, z: 0 }, ra: { x: 0, y: 0, z: 0 }, le: { x: 0, y: 0, z: 0 }, re: { x: 0, y: 0, z: 0 }, ll: { x: 0, y: 0, z: 0 }, rl: { x: 0, y: 0, z: 0 }, lk: { x: 0, y: 0, z: 0 }, rk: { x: 0, y: 0, z: 0 } },
        { percentage: 20, name: '20% Right Hand Moving Forward', la: { x: 0, y: 0, z: 0 }, ra: { x: 0, y: -25, z: 0 }, le: { x: 0, y: 0, z: 0 }, re: { x: 0, y: 0, z: 12 }, ll: { x: 0, y: 0, z: 0 }, rl: { x: 0, y: 0, z: 0 }, lk: { x: 0, y: 0, z: 0 }, rk: { x: 0, y: 0, z: 0 } },
        { percentage: 50, name: '50% Right Hand Touch Sensor Forward', la: { x: 0, y: 0, z: 0 }, ra: { x: 0, y: -50, z: 0 }, le: { x: 0, y: 0, z: 0 }, re: { x: 0, y: 0, z: 25 }, ll: { x: 0, y: 0, z: 0 }, rl: { x: 0, y: 0, z: 0 }, lk: { x: 0, y: 0, z: 0 }, rk: { x: 0, y: 0, z: 0 } },
        { percentage: 80, name: '80% Right Hand Returning', la: { x: 0, y: 0, z: 0 }, ra: { x: 0, y: -25, z: 0 }, le: { x: 0, y: 0, z: 0 }, re: { x: 0, y: 0, z: 12 }, ll: { x: 0, y: 0, z: 0 }, rl: { x: 0, y: 0, z: 0 }, lk: { x: 0, y: 0, z: 0 }, rk: { x: 0, y: 0, z: 0 } },
        { percentage: 100, name: '100% Return to Normal Rest', la: { x: 0, y: 0, z: 0 }, ra: { x: 0, y: 0, z: 0 }, le: { x: 0, y: 0, z: 0 }, re: { x: 0, y: 0, z: 0 }, ll: { x: 0, y: 0, z: 0 }, rl: { x: 0, y: 0, z: 0 }, lk: { x: 0, y: 0, z: 0 }, rk: { x: 0, y: 0, z: 0 } }
    ],
    jump: [

...
export const JokerMinigameConfig = {
    // Rounds that trigger minigame interval phases before choosing phase starts
    MINIGAME_ROUNDS: [4, 8, 12],

    // Individual Timers (durations in seconds) for Each Minigame:
    SLIP_CARD_GAME_DURATION_SEC: 30,     // Timer for Round 4 Slip Card Game
    REFLEX_GAME_DURATION_SEC: 30,        // Timer for Round 8 Reflex Game
    TRUST_PAIRS_GAME_DURATION_SEC: 30,    // Timer for Round 12 Trust Pairs Game
    DEFAULT_MINIGAME_DURATION_SEC: 30,    // Default Minigame Timer

...
export const JokerBriefing: React.FC<JokerBriefingProps> = ({ timeLeft, onStartGame }) => {
    return (
        <div className="fixed inset-0 z-[30] bg-white/95 sm:bg-slate-950/70 sm:backdrop-blur-md flex items-center justify-center p-2 sm:p-6 sm:pt-24 overflow-y-auto no-scrollbar font-mono select-none">
            <motion.div

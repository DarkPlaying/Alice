    ...
    return (
        <div className="fixed inset-0 z-[1000] bg-white flex flex-col items-center justify-center p-2 sm:p-6 overflow-y-auto no-scrollbar font-mono select-none">
            <motion.div
                ...
                className="w-full max-w-lg sm:max-w-2xl bg-white border border-slate-200 rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.06)] overflow-hidden flex flex-col font-mono text-slate-900 relative max-h-[92vh] overflow-y-auto no-scrollbar"
            >
                {/* Header */}
                <div className="p-3.5 sm:p-6 border-b border-slate-100 bg-white flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2 sm:gap-3">
                        <div className="p-1.5 sm:p-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 shrink-0">
                        ...
                        <div>
                            ...
                            <p className="text-[8px] sm:text-[10px] text-slate-400 font-bold uppercase tracking-wider mt-1">
                                TACTICAL BRIEFING // INDIVIDUAL 14-ROUND LABYRINTH
                            </p>
                        </div>
                    </div>

                    <div className="flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3.5 sm:py-2 bg-white border border-slate-200 rounded-xl shadow-sm shrink-0">
                ...
                {/* Content Body */}
                <div className="p-3.5 sm:p-6 space-y-3 sm:space-y-5 text-xs text-slate-800 leading-relaxed font-mono bg-white">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[11px]">
                        <div className="p-3.5 bg-slate-50/70 border border-slate-100 rounded-xl shadow-sm">

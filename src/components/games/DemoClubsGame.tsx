...
import { Timer, FileText, User, RotateCcw } from 'lucide-react';
...
export const DemoClubsGame: React.FC<DemoClubsGameProps> = ({ user }) => {
    ...
    // ── HUD ────────────────────────────────────────────────────────────────
    const renderHUD = () => (
        <div className="sticky top-0 left-0 right-0 z-[210] px-3 py-2 sm:px-6 sm:py-3 border-b border-white/5 flex items-center justify-between bg-black gap-2">
            {/* Left: Rules button */}
            <button
            ...
            <div className="flex items-center gap-3 sm:gap-6">
                ...
                <div className="text-center">
                    ...
                    <p className="text-[9px] font-bold text-yellow-500 truncate max-w-[60px]">{myName.toUpperCase()}</p>
                ...
                <div className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-1">
                        ...
                        <p className="text-xs sm:text-base font-mono font-black text-red-500 leading-none tabular-nums">
            ...
            {/* Right: nothing on mobile, keeps layout balanced */}
            <div className="w-8" />
        </div>
    );
    ...
    // ── Main Render ────────────────────────────────────────────────────────
    return (
        <div className="relative w-full h-full min-h-screen bg-[#050508] flex flex-col font-sans text-white overflow-x-hidden">
            {/* Modals */}
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-8 relative bg-black/40">
                ...
                {phase === 'setup_phase1' && (
                    <div className="max-w-md mx-auto mt-8 bg-zinc-900/60 border border-white/5 rounded-xl p-4 text-center">
                        <p className="text-xs font-mono text-white/40 mb-2 uppercase tracking-widest">DEMO-BOT TARGETS</p>
                        <div className="flex justify-around">
                            <div>
                                <span className="text-[10px] text-white/30 block">ANGEL</span>
                                <span className="text-yellow-400 font-bold text-lg">A</span>
                            </div>
                            <div>
                                <span className="text-[10px] text-white/30 block">DEMON</span>
            ...
            <AnimatePresence>
                {phase === 'result' && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-[200] flex flex-col items-center justify-start pt-10 gap-6 bg-black/97 overflow-y-auto pb-12"
                    ...
                    >
                        ...
                        <div className="text-center flex flex-col gap-3">
                            ...
                            <h2 className="text-xs font-bold font-mono text-green-500 tracking-[0.4em] uppercase">
                        ...
                        <div className="w-full max-w-xl px-4 sm:px-0">
                            <div className="relative rounded-2xl bg-zinc-950/90 border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.6)] overflow-hidden flex flex-col sm:flex-row items-stretch p-0">
                                ...
                                <div className="flex-1 min-h-[100px] flex flex-col items-center justify-center p-5 sm:border-r border-b sm:border-b-0 border-white/5 bg-zinc-900/40">
                                    <p className="text-zinc-500 font-mono text-[9px] uppercase tracking-[0.4em] mb-2">NET MERIT</p>
                                    <p className="text-4xl sm:text-6xl font-black font-oswald text-white">{myScore}</p>
                                </div>
                                <div className="flex-1 flex flex-col p-5 gap-3 justify-center bg-black/20">
                                    <div className="flex items-center justify-between border-b border-white/5 pb-2">
                                        <span className="text-zinc-500 text-[10px] font-mono tracking-widest uppercase">CONDITION</span>
                                        <span className="text-xs font-bold font-mono tracking-[0.2em] uppercase text-green-400">SURVIVED</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Demo CTA */}
                        <div className="w-full max-w-xl px-4 sm:px-0">
                            <div className="relative overflow-hidden bg-gradient-to-br from-red-950/60 to-black/80 border border-red-500/30 rounded-2xl p-5 text-center">
                                ...
                                <p className="text-white font-bold font-cinzel tracking-widest text-base mb-1">WANT TO PLAY THE REAL GAME?</p>
                        ...
                        <div className="w-full max-w-xs px-4 sm:px-0">
                            <button
                                ...
                                className="group w-full h-14 bg-green-600 hover:bg-green-500 border border-green-400/50 rounded-xl shadow-[0_0_20px_rgba(34,197,94,0.4)] transition-all duration-300 hover:scale-[1.02] active:scale-95 flex items-center justify-center"
                            >
                                <span className="font-mono font-black tracking-[0.2em] uppercase text-white text-sm">
                                    → Enter Another Arena
                                </span>
                            </button>
                        </div>
